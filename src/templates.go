...
func generateHTMLTemplate(title string, htmlContent string, sourcePath string, pageGraph *PageGraph, navTreeJSON string) string {
	...
	* { box-sizing: border-box; }
	...
	.search-bar { width: 100%; background: var(--card-bg); border: 1px solid var(--border); color: var(--muted); cursor: pointer; padding: 6px 10px; border-radius: 4px; font-size: 0.85em; text-align: left; margin-bottom: 12px; }
...
<div class="layout">
    <aside class="sidebar-nav">
        ...
        <button id="open-search" class="search-bar" type="button">&#8981; Search</button>
